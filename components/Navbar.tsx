...
const Navbar = () => {
  return (
    <footer className="fixed bottom-6 left-1/2 z-10 w-4/5 -translate-x-1/2 rounded-3xl border border-gray-300 bg-white/80 px-2.5 py-1.5 shadow-md backdrop-blur-sm dark:border-gray-700 dark:bg-gray-900/80 dark:shadow-gray-900 sm:w-auto sm:p-2.5">
